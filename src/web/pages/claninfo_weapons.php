...
?>
	...
	while ($rowdata = $db->fetch_array($result)) {
	    ...
	    $weapon_data['total']['chest']					+= (int)$rowdata['smchest'];
	    ...
	    $weapon_data[$rowdata['smweapon']]['chest']		= (int)$rowdata['smchest'];
