...
*/
    ...
    // Security Fix: HTTP_REFERER is user input, must be sanitized against XSS
    $lastpage = isset($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : "";
    
    // Ensure style is set
    $style = isset($g_options['style']) ? $g_options['style'] : 'default.css';
?>
...
<div style="width:100%;height:50px;" class="headerblock">
    <img src="<?php echo htmlspecialchars(IMAGE_PATH); ?>/icons/title.png" alt="HLstats" />
    <?php 
    if ($lastpage) {
	?>
	<div style="position: absolute; bottom:45%; right:0; color: #FFFFFF;">
	    <a href="<?php echo htmlspecialchars($lastpage, ENT_QUOTES, 'UTF-8'); ?>">&laquo;&nbsp;&nbsp;Go Back</a>
	</div>
	<?php 
    } ?>
</div>